...
#define ICM_INT_CONFIG_INT2						3
#define ICM_INT_CONFIG_INT1						0
#define ICM_INT_CONFIG_MODE						2
#define ICM_INT_CONFIG_DRIVE_CIRCUIT			1
#define ICM_INT_CONFIG_POLARITY					0
/* FIFO_CONFIG */
...
{
	PULSED_MODE = 0<<ICM_INT_CONFIG_MODE,
	LATCHED_MODE = 1<<ICM_INT_CONFIG_MODE
} ICM42688_INT_MODE_t;

typedef enum __INT_DRIVE_CIRCUIT
{
	OPEN_DRAIN = 0<<ICM_INT_CONFIG_DRIVE_CIRCUIT,
	PUSH_PULL = 1<<ICM_INT_CONFIG_DRIVE_CIRCUIT
} ICM42688_INT_DRIVE_CIRCUIT_t;

typedef enum __INT_POLARITY
{
	ACTIVE_LOW = 0<<ICM_INT_CONFIG_POLARITY,
	ACTIVE_HIGH = 1<<ICM_INT_CONFIG_POLARITY
...
typedef enum {
	GYRO_AAF_ENABLE	= 	0<<ICM_GYRO_CONFIG_STATIC2_GYRO_AAF_DIS,
	GYRO_AAF_DISABLE = 	1<<ICM_GYRO_CONFIG_STATIC2_GYRO_AAF_DIS
} ICM42688_GYRO_AAF_Enable_t;

typedef enum {
	GYRO_NF_ENABLE = 	0<<ICM_GYRO_CONFIG_STATIC2_GYRO_NF_DIS,
	GYRO_NF_DISABLE = 	1<<ICM_GYRO_CONFIG_STATIC2_GYRO_NF_DIS
